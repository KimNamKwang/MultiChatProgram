...
{
    public partial class MultiChat1 : Form
    {
        ...
        private void btnSelectFile_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Multiselect = true; //다중파일선택
            openFileDialog1.ShowDialog();


            // 폴더 안에 있는 파일 제목을 ComboBox에 추가
            string[] files = openFileDialog1.FileNames;
            //string[] files1 = openFileDialog1.OpenFile();
        ...
        private void richTextBoxForSendFile_TextChanged(object sender, EventArgs e)
        {

        }

        private void listBoxForSendData_SelectedIndexChanged(object sender, EventArgs e)
        {
